...
void torsion_analysis() {
  ofstream myfile;
  //Apre file dati
  //TFile * in_file = new TFile("recoDataSimple_415.torsion.histo.root");
  TFile * in_file = new TFile("recoDataSimple_410.notorsion.histo.root");

  //TString outputfile = "recoDataSimple_415.torsion.graph.root";
  TString outputfile = "recoDataSimple_410.torsion.graph.root";
  ...
  */
  ...
  /*
  TH1D *hs= h->ProjectionX("z slice",60,60,81,81);
  ...
  */
  ...
  TF1 * flin_new = new TF1("flin_new","pol1",-2.,2.);
