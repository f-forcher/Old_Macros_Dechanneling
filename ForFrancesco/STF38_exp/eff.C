...
void eff() {
  ...
  //Apre file dati
  TFile * in_file = new TFile("recoDataSimple_546_31-59.torsion.correction.histo.root");
  //TFile * in_file = new TFile("STF38Rob_Exp.root");
  ...
  TString outputfile = "STF47Rob.efficiency_Exp.root"; 
 ...
 //plot e fit 
  ...
  h5->Draw();
  Double_t par_ch5[3];
  TF1 *g5    = new TF1("g5","gaus",200,300);
  ...
  h10->Draw();
  Double_t par_ch10[3];
  TF1 *g10    = new TF1("g10","gaus",200,300);
  ...
  */
  ...
  int bmax10 = x_axis10->FindBin(300); 
