...
void H8_style_study(){
  ...
  filename="recoDataSimple_546_31-59.torsion.correction.histo.root";
  nhead=0;
  ...
  TH2F *hH8=new TH2F("hH8","histo H8 style",100,-50,50,350,-50,300);
  ...
  TFile *f=new TFile("STF38Rob_Exp.root","new");
