...
void eff() {
  ...
  //Apre file dati
  //TFile * in_file = new TFile("recoDataSimple_630.torsion.correction.histo.root");
TFile * in_file = new TFile("STF49Rob_Exp.root");
  ...
  TString outputfile = "STF49Rob.efficiency_Exp.root"; 
