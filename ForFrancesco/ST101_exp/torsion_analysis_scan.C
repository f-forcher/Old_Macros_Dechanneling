...
//torsion analysis for angular scan

void torsion_analysis_scan() {
  ofstream myfile;
  //Apre file dati
  TFile * in_file = new TFile("recoDataSimple_2260.torsion.histo.root");
   
  TString outputfile = "recoDataSimple_2260.torsion.graph.root"; 
