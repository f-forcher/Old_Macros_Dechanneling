...
void torsion_histo(){
  ...
  TString outputfile = "recoDataSimple_2262.torsion.histo.root";
  ...
  */
  ...
  dTheta_x->GetXaxis()->SetTitle("#Delta#theta_{x} [#murad]");
  ...
  int count_d0xcut = 0;
  int angle_cut = 0;
  Maxd0x = 0.6;    // inserisco qui gli estremi deli tagli
  mind0x = -0.2;
  Maxd0y = 1.5;    // tagli in y approssimativi, mancando l'alignment (sigma= 2.3)
  mind0y = -1.5;
