...
void torsion_histo_corr_scan(){
  ...
  */
  ...
  TH1D * dTheta_x = new TH1D("dTheta_x","dTheta_x",400,-400.,400.);
  TH1D * ThetaIn_x = new TH1D("ThetaIn_x","ThetaIn_x",400,-400.,400.);  
  TH3D * dTheta_x_vs_Impact_x_vs_Impact_y = new TH3D("dTheta_x_vs_Impact_x_vs_Impact_y","dTheta_x_vs_Impact_x_vs_Impact_y", 400,-300.,200.,450,-200., 200.,100,-3.,3.);
  ...
  TH2D * dTheta_x_vs_Impact_x_cor = new TH2D("dTheta_x_vs_Impact_x_cor","dTheta_x vs Impact_x tor Corr",450,-300.,200., 600,-200.,400.);
...
TH2D * dTheta_x_vs_Impact_x_cor_w = new TH2D("dTheta_x_vs_Impact_x_cor_w","dTheta_x vs Impact_x tor Corr weight",450,-300.,200., 600,-200.,400.);
  ...
  TH2D * dTheta_x_vs_gonio_nocut_zero = new TH2D("dTheta_x_vs_gonio_nocut_zero" , " dTheta_x_vs_gonio zero", 400., -100., 400., 1400,-200.,400.);
  ...
  for (Int_t i = 0; i < nentries; i++) {
    ...
    ThetaIn_x->Fill((tracks.thetaIn_x*1e6)-((a*tracks.d0_y)));
      //  if (cutd0x && cutd0y) {
      //	count_d0xcut++;
      ...
      dTheta_x_vs_gonio_nocut_zero->Fill((gPos.x-init_scan),(tracks.thetaOut_x - tracks.thetaIn_x)*1e6);
 ...
 dTheta_x_vs_gonio_nocut_zero->Draw("colz");
