...
//histo for torsion analysis for angular scan
void torsion_histo_scan(){
  ...
  TString outputfile = "recoDataSimple_2260.torsion.histo.root"; 
  ...
  */
  ...
  for (Int_t i = 0; i < nentries; i++) {
    ...
    if(singleTrack==1 && cutd0x && cutd0y) {
      ...
      dTheta_x_vs_Impact_x_vs_Impact_y->Fill((tracks.thetaOut_x - tracks.thetaIn_x)*1e6,gPos.x+(tracks.thetaIn_x*1e6)-init_scan,tracks.d0_y);
