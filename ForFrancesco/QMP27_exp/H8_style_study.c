...
void H8_style_study(){
  ...
  filename="recoDataSimple_348.torsion.correction.histo.dat";
  nhead=0;
  ...
  TH2F *hH8=new TH2F("hH8","histo H8 style",100,-50,50,200,-50,150);
  ...
  TFile *f=new TFile("QMP27Rob_Exp.root","new");
