...
//	slices(190,190+deltaslice,hAM);
	...
	STF45_par["lowYrange_slices"] = -40; // murad. What range save of the slices
	STF45_par["highYrange_slices"] = 30; // murad. What range save of the slices
	...
	// TODO Non funziona...
	analisi_VRtoAM_chi2("STF45","exp",155, 35, STF45_par);
	//analisi_VRtoAM_chi2("STF45","sim",160, 30, STF45_par);
