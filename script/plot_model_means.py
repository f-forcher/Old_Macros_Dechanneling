...
plt.plot([from_slice,theta_bending], [theta_vr,theta_vr], linestyle="solid", label="", color='Navy')
plt.plot([theta_bending,theta_bending + 2*theta_c], [theta_vr,theta_vr-sigma_VR], linestyle="solid", label="VR means", color='Navy')
...
plt.plot([theta_bending,theta_bending + 2*theta_c], [sigma_AM,0], linestyle="solid", label="AM means", color='DarkOrange')
plt.plot([theta_bending + 2*theta_c,to_slice], [0,0], linestyle="solid", label="", color='DarkOrange')
