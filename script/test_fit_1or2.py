...
slopeAM, interceptAM, r_valueAM, p_valueAM, std_errAM = stats.linregress(
    list(weights_AM.keys()), list(weights_AM.values()))
print("slopeAM: ", slopeAM, "interceptAM: ", interceptAM)
print("Transition extrema (lin fit): ", -(interceptAM - 1) / slopeAM, "-",
      -interceptAM / slopeAM)
